...
const roles = [
  {
    ...
    color: "white",
    bullets: [
      "Own PMO governance across 4–6 concurrent Data Platform and AI programs ($3.5M+ combined contract value) — RACI, WBS, decision logs, and risk registers maintained from kickoff through delivery close.",
      "Manage full financial governance for active programs — monthly invoicing, budget forecast vs. actuals, and variance reporting to client and internal leadership.",
      "Primary bridge between the engineering delivery team and client C-level/VP stakeholders — own weekly status reporting, quarterly business reviews, and escalation management.",
      ...
      "Built AI agents (Glean + Claude + n8n) for financial reviews, status briefs, and program setup — saving 5+ hours a week. Won phData's Innovation Award.",
