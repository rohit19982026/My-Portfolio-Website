...
const roles = [
  {
    ...
    bullets: [
      ...
      "Maintain RACI, WBS, decision logs, and risk registers across every active program, from kickoff through delivery close.",
      ...
      "Turn program data — burn rates, approval wait-times, ticket ages — into the weekly status and risk reports leadership and clients act on, so problems surface before they're client-visible.",
      "Primary bridge between the engineering delivery team and client C-level/VP stakeholders — own weekly status reporting, quarterly business reviews, and escalation management; issues get root-caused and fixed systemically, not patched over.",
      "Own the presales-to-delivery lifecycle — scope engineering effort with Principal Architects during presales, structure SOWs for delivery governance, then carry programs through execution.",
      ...
      "Unblocked 17 external approvals stalled for weeks by assigning a named owner and day-count to each.",
      "Cut a managed retainer's UAT cycle from 11 days to 4 by tracing the pipeline bottleneck and escalating specific items to accountable owners.",
      "Built AI agents (Glean + Claude + n8n) that generate status and risk reports, run financial reviews, and automate program setup — now standard workflow across the PMO team. Saves 5+ hours a week; won phData's Innovation Award.",
      "Scoped 10+ programs end to end; logged and resolved 14 out-of-scope additions on one engagement so none became free work.",
    ],
    tags: ["PMO Governance", "RACI · WBS · Risk Register", "Financial Management", "C-Level Stakeholder Mgmt", "Presales-to-Delivery", "Account Expansion", "Scrum Master (PSM1)", "AI Agent Builder", "Predictive Risk Reporting"],
  },
  {
