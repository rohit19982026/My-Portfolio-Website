...
const nodes: DiagramNode[] = [
  ...
  { id: "jira",    x: 10,  y: 94,  w: 100, h: 64, label: "Jira",           sub: "", eyebrow: "TOOL CALL", tone: "blue" },
  { id: "slack",   x: 120, y: 94,  w: 100, h: 64, label: "Slack",          sub: "", eyebrow: "TOOL CALL", tone: "blue" },
  { id: "notes",   x: 230, y: 94,  w: 100, h: 64, label: "Meeting\nNotes", sub: "", eyebrow: "TOOL CALL", tone: "blue" },
  { id: "agent",   x: 70,  y: 178, w: 200, h: 44, label: "Standup Agent",  sub: "Claude",         tone: "lime" },
  { id: "brief",   x: 50,  y: 242, w: 240, h: 48, label: "One-Page Brief", sub: "30-second read", tone: "white" },
...
const edges: DiagramEdge[] = [
  ...
  { d: roundedPath([[170, 74], [60, 94]]),    delay: 0.15 },
  { d: roundedPath([[170, 74], [170, 94]]),   delay: 0.2 },
  { d: roundedPath([[170, 74], [280, 94]]),   delay: 0.25 },
  { d: roundedPath([[60, 158], [170, 178]]),  delay: 0.4 },
  { d: roundedPath([[170, 158], [170, 178]]), delay: 0.45 },
  { d: roundedPath([[280, 158], [170, 178]]), delay: 0.5 },
  { d: roundedPath([[170, 222], [170, 242]]), delay: 0.65 },
  { d: roundedPath([[170, 290], [170, 304]]), delay: 0.75 },
];
