...
const nodes: DiagramNode[] = [
  ...
  { id: "trigger",  x: 30,  y: 32,  w: 280, h: 42, label: "Month-End Trigger",         sub: "Runs 1st business day",       tone: "ink",  icon: "trigger" },
  { id: "pull",     x: 30,  y: 90,  w: 280, h: 40, label: "Tool Call: PSA + Timecard", sub: "Budget & time data",          tone: "blue", icon: "tool" },
  { id: "agent",    x: 70,  y: 146, w: 200, h: 44, label: "Billing Review Agent",      sub: "Glean Agent · Claude",        tone: "lime", icon: "agent" },
  ...
  { id: "flag",     x: 70,  y: 300, w: 200, h: 44, label: "Flag Report",          sub: "Synthesized findings", tone: "lime",  icon: "output" },
  { id: "review",   x: 70,  y: 360, w: 200, h: 44, label: "PM + Team Review",     sub: "Human sign-off",       tone: "white", icon: "human" },
...
const edges: DiagramEdge[] = [
  ...
  { points: [[170, 74], [170, 90]],   delay: 0.15 },
  { points: [[170, 130], [170, 146]], delay: 0.25 },
  { points: [[170, 190], [60, 210]],  delay: 0.35 },
  { points: [[170, 190], [170, 210]], delay: 0.4 },
  { points: [[170, 190], [280, 210]], delay: 0.45 },
  { points: [[60, 280], [170, 300]],  delay: 0.6 },
  { points: [[170, 280], [170, 300]], delay: 0.65 },
  { points: [[280, 280], [170, 300]], delay: 0.7 },
  { points: [[170, 344], [170, 360]], delay: 0.85 },
  { points: [[170, 404], [170, 414]], delay: 0.95 },
];
