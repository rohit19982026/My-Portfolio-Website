...
const roles = [
  {
    ...
    color: "#7C3AED",
    bullets: [
      "Governed 4–5 concurrent data and AI programs simultaneously — Snowflake migrations, Databricks builds, cloud warehouse projects, GenAI tooling — with full SDLC ownership from commercial scoping through delivery close.",
      "Owned P&L across all active programs — EAC modelling, invoicing governance, margin tracking, and budget variance management. Program values ranged from $500K to $5M+.",
      "Served as primary executive stakeholder across 10+ enterprise accounts — led QBRs with VP and Director-level clients, structured reporting so risks reached the page before the meeting room.",
      "Designed and deployed PMO automation using Glean AI agents and Google Apps Script — automated status reporting, OKR tracking, and Slack-based program health dashboards, recovering ~8 hours/week of PM capacity across active programs.",
      "Led pre-sales scoping and SOW negotiation on the majority of accounts — defined delivery estimates, validated technical feasibility, and drove commercial terms on new engagements and contract extensions.",
      "Led cross-functional delivery teams of 15–30 across data engineering, analytics, DevOps, and client stakeholders — governing resource allocation, cross-timezone dependencies (US + India), and parallel workstream sequencing.",
    ],
  ...
  },
  {
    ...
    color: "#059669",
    bullets: [
      "Progressed from Trainee Associate → Associate → Change Management Specialist within 2.5 years at BT GBS, driven by consistent ownership of high-stakes change events.",
      "Governed ITIL-compliant IT infrastructure change programs — led CAB governance, risk assessment, rollback planning, and post-implementation validation across 50+ changes annually. Maintained 99.9% uptime across critical telecom infrastructure.",
      "Owned change authorisation for firewall, SSL, inter-switch link, and ACL requests across corporate and public sector BT customers — reviewing and approving Standard, Normal, Expedited, and Emergency changes.",
      "Led cross-functional communication across all change events — pre-change briefings, real-time status updates during change windows, and post-implementation reports to business and technology leadership.",
    ],
