...
export const caseStudies: CaseStudy[] = [
  ...
  // ===========================================================================
  {
    ...
    challenges: [
      ...
      { label: "Embedded engineer was the team's de facto data domain owner. Contract structure implicitly demoted his expertise. Treating him as a handoff recipient created friction in every technical decision for a year.", severity: "high" },
    ...
    orchestration: [
      ...
      { team: "Embedded Engineer", role: "De facto data domain owner. Needed to become roadmap co-owner, not handoff recipient.", type: "client" },
    ...
    decisions: [
      {
        ...
        outcome: "Renewal approved. Year two started with 40% more scope because the value case was legible.",
      },
      {
        ...
        risk: "Continuing the vendor framing would have left a resistant, expert client team at the handoff moment.",
      ...
      },
      {
        ...
        tradeoff: "Required reframing a potential problem as a proof point — a harder argument to make.",
    ...
    impact: [
      { value: "2 renewals", label: "because the value case was legible to Finance", tone: "primary" },
  ...
  // ===========================================================================
  {
    ...
    challenges: [
      { label: "US and China teams had different answers to 'what is a unit produced.' Not different data — different business logic in SAP and Oracle built independently over different timescales. A data engineering solution to a business policy question would have been wrong.", severity: "high" },
    ...
    journey: [
      ...
      },
      {
        ...
        detail: "Week four: two dashboard requirements outside scope. Assessed the impact: absorbing them required either a delivery slip or a quality trade-off in a six-week window with a hard close date. Three options: absorb and slip, absorb and cut quality, or negotiate a post-delivery addendum. Didn't present three options to the sponsor. Presented one: post-delivery addendum, with the reason — absorbing changes the delivery date or breaks quality, and neither is acceptable at week four of six. He chose the addendum. Closed on original scope.",
      },
    ],

    orchestration: [
      { team: "Client Sponsor", role: "Had to make the business policy decision on production output — not a technical decision, a business one.", type: "exec" },
    ...
    decisions: [
      ...
      },
      {
        ...
        tradeoff: "An uncomfortable check-in — felt like micromanagement to the team lead.",
    ...
    impact: [
      ...
      { value: "2 days", label: "to unblock SAP via a lateral relationship", tone: "ok" },
  ...
  // ===========================================================================
  {
    ...
    ecosystem: {
      ...
      pipeline: ["Proof data before permission", "Accountability chain before accuracy argument", "Sequenced by trust-building", "Cohort rollout — not a launch"],
    ...
    journey: [
      ...
      },
      {
        ...
        detail: "Three cohorts. Cohort one (three PMs) went first — their feedback changed the Sprint Health Summarizer output format before cohort two saw it. Non-adopters got a one-on-one — not to push usage, to diagnose whether the agent was solving the right problem. Tracked usage per agent per PM from week one. Two agents needed changes based on cohort feedback. Fixed them before the next cohort. By cohort three, PMs were asking when the next agent was coming. Adoption followed the fix, not the launch.",
      },
    ],

    orchestration: [
      { team: "Finance Team", role: "Billing data access. Needed an accountability chain and audit trail — not just an accuracy number.", type: "client" },
    ...
    decisions: [
      {
        ...
        risk: "Asking for approval without a proof point would have been a much harder conversation — abstract AI governance vs. concrete before/after data.",
      ...
      },
      {
        ...
        risk: "Showing up without an accountability chain would have ended the conversation at the first question.",
    ...
    beforeAfter: {
      ...
      after: [
        ...
        "Governance case built from proof data — Finance approved because the accountability chain was visible.",
