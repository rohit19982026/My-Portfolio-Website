...
export const caseStudies: CaseStudy[] = [
  {
    ...
    outcome: "Redshift → Databricks Unity Catalog · fixed-price, US + India pod · the political work was the real work",
    industry: "EDTECH",
    year: "2025–26",
    model: "FIXED-PRICE",
    entry: {
    ...
    role:
      "PM end-to-end. The official scope was the standard list — kickoff, weekly cadence, status, RAID, cutover, closure. The actual scope, once I'd sat through two meetings, was figuring out how to make the client's data lead a co-owner of the project rather than its quiet skeptic.",
    actions: [
      "Set the program up clean against the SOW in the first week — budget and roles checked, a second PM's eyes on the plan before anything went external, both kickoff decks rehearsed. Access requests went out the same day, because access was always going to be the blocker.",
    ...
    decisions: [
      ...
      "Flagged a sub-deliverable yellow in week 4 not because anything had broken yet, but because on fixed-price every week of access delay is a week you can't earn back. The AE used the yellow to open a client-side conversation that had been overdue.",
      "Said no to a hallway-request adjacent dashboard in week 9. Got the architect's estimate in writing, took it to the AE, routed it through change-order. Lost a small bit of client goodwill that week; protected the margin on a fixed-price engagement for the rest of the year.",
    ],
  ...
  },
  {
    ...
    number: "002",
    type: "PLATFORM BUILD",
    title: "Two Years of T&M, and the Engineer I Couldn't Win Over",
    outcome: "MWAA + dbt + Snowflake · multi-year T&M · renewed twice · one stakeholder I read wrong the whole time",
    ...
    entry: {
      mode: "kickoff",
      narrative:
        "Joined at SOW signature on a multi-year T&M build. T&M means burn is the constant conversation. On a two-year engagement, the relationship with the AE and the client sponsor matters as much as anything on the sprint board — and so does the one client-side engineer who decided in week three they didn't trust consultants, and then stayed that way.",
    },
    spotlight: "decisions",
    context:
      "A multi-year T&M engagement building a marketing data platform on MWAA, dbt, and Snowflake. The sponsor needed VP-language updates. The product owner needed weekly delivery confidence. And the client-side senior data engineer — six years in their role, three platform migrations under their belt — needed reasons to believe we weren't going to make their life worse. We got two out of three right for most of the engagement.",
    role:
      "PM end-to-end. Financial tracking, weekly status, internal and client leadership meetings, RAID, change-order surfacing, the renewal-adjacent conversations. The engineers and architect owned the build; I held the cadence steady and read the room — sometimes wrongly — on the client side.",
    actions: [
      ...
      "Surfaced two adjacent problem areas the client mentioned in passing as scope-growth signals to the AE — they turned into formal change-orders rather than free work absorbed into the burn.",
      "Held the line on a hallway request for an out-of-scope dashboard. Got the architect's estimate, sized the change-order with the AE, either it went in officially or it didn't.",
      "Kept burn vs. SOW reconciled every Friday against the PMO's own reporting so my numbers and leadership's numbers always told the same story when the quarterly renewal conversations came around.",
    ...
    result: "✓ MULTI-YEAR T&M · RENEWED TWICE · CHANGE-ORDERS RAISED CLEAN · ONE LESSON IN STAKEHOLDER TRIAGE",
  ...
  },
  {
    ...
    context:
      "A T&M Snowflake build for a global manufacturer's China factory operations. 3-timezone delivery, a 10.5-hour gap. Six-week window with Lunar New Year sitting three weeks in. The structural challenges (timezone, holiday) were design problems with reasonable answers. The actual hard moment of the engagement was a fifteen-minute decision I made in a leadership meeting that should have been a 1:1 conversation an hour earlier.",
    role:
      "PM across the timezone spread and the holiday — kickoff, cadence design, weekly status across all three regions, RAID, financials, closure. And — the part I should have understood faster — bridging between a US delivery lead and a China-site client whose default mode was to defer in groups and disagree in private.",
    actions: [
  ...
  },
  {
    ...
    outcome: "Glean + Claude + n8n · 6 agents PMO-wide · started as one person's frustration, ended as everyone's tool",
    ...
    entry: {
      mode: "built",
      narrative:
        "Self-initiated. End-of-month billing reconciliation was three or four hours of copy-paste between the time-tracking export and the SOW budget, every program, every month. I'd done it by hand for nearly two years. None of it required judgment. So I built the agent on a Saturday, then spent the next three months turning the prototype into something the rest of the PMO would actually trust.",
    },
    spotlight: "metrics",
    headlineMetrics: [0, 1],
    context:
    ...
    actions: [
      "Spent the first two weeks watching my own EOM by hand, again, with a notepad — not building anything. Listed everything the agent would need to do: pull time data, compare against SOW budget, flag overages and underages, produce a finance-ready summary in plain English, and — critically — surface anything weird for human review rather than silently produce a number that looked clean.",
      "Built on Glean rather than a direct API integration. Glean was already the PMO's knowledge and permissions layer. Building there meant the agent could see live program data, Salesforce, and Drive without a separate integration build. Less impressive on paper; far faster to ship; far easier for a non-technical PM to trust.",
      ...
      "Shipped the billing agent first, deliberately. It was the highest-pain, most-measurable use case — if it didn't hold up, nothing after it would land either. Once it was running PMO-wide inside a month, the next five had an easier path in.",
    ],
    decisions: [
    ...
    result: "✓ 6 AGENTS IN PRODUCTION · ~8 HRS/WEEK RECOVERED · phData INNOVATION AWARD · PMO-WIDE ADOPTION",
