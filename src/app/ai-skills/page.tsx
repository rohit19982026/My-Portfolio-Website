...
function SectionHead({ num, title, accent, lede }: { num: string; title: string; accent: string; lede: string }) {
  return (
    <div>
      ...
      <h2 style={{ fontFamily:"'Sora',system-ui,sans-serif", fontSize:"clamp(30px,4vw,48px)", fontWeight:700, lineHeight:1.05, letterSpacing:"-0.03em", color:T1, marginBottom:14 }}>
        {title}{" "}
    ...
    <div style={{ background:"#fff", border:`1px solid rgba(29,78,216,0.14)`, borderRadius:18, padding:"28px 24px", boxShadow:"0 4px 20px rgba(29,78,216,0.06)", margin:"24px 0" }}>
      <svg viewBox="0 0 820 260" style={{ width:"100%", height:"auto", display:"block", overflow:"visible" }} xmlns="http://www.w3.org/2000/svg">
        ...
        <g>
          ...
          <text x="95" y="75" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:13, fontWeight:600, fill:T1 }}>CSV Input</text>
        ...
        <g>
          ...
          <text x="310" y="68" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:13, fontWeight:600, fill:T1 }}>Parser + Router</text>
        ...
        <g>
          ...
          <text x="735" y="75" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:13, fontWeight:600, fill:T1 }}>PM Report</text>
        ...
        <rect x="340" y="228" width="180" height="50" rx="10" fill="#ECFDF5" stroke={GR} strokeWidth="1.5"/>
        <text x="430" y="249" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:12, fontWeight:600, fill:"#065F46" }}>Blocker Analysis</text>
        ...
        <g>
          ...
          <text x="710" y="249" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:12, fontWeight:600, fill:"#155E75" }}>PM Action Items</text>
  ...
  return (
    <div style={{ background:"#fff", border:`1px solid rgba(29,78,216,0.14)`, borderRadius:18, padding:"28px 24px", boxShadow:"0 4px 20px rgba(29,78,216,0.06)", margin:"24px 0" }}>
      <svg viewBox={`0 0 ${W} 200`} style={{ width:"100%", height:"auto", display:"block" }} xmlns="http://www.w3.org/2000/svg">
        ...
        {[
          { x:80,  color:"#DC2626", bg:"rgba(220,38,38,0.1)",   label:"🔴 Critical" },
          { x:230, color:"#D97706", bg:"rgba(217,119,6,0.1)",   label:"⚠️ Warning" },
    ...
    <div style={{ background:"#fff", border:`1px solid rgba(29,78,216,0.14)`, borderRadius:18, padding:"28px 24px", boxShadow:"0 4px 20px rgba(29,78,216,0.06)", margin:"24px 0" }}>
      <svg viewBox="0 0 820 280" style={{ width:"100%", height:"auto", display:"block" }} xmlns="http://www.w3.org/2000/svg">
        ...
        <g>
          ...
          <text x="102" y="76" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:13, fontWeight:700, fill:T1 }}>Intent Received</text>
        ...
        <g>
          ...
          <text x="510" y="67" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:12, fontWeight:600, fill:T1 }}>Inline Response</text>
        ...
        <g>
          ...
          <text x="310" y="190" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:12, fontWeight:600, fill:T1 }}>Deterministic</text>
        ...
        {/* Memory limit badge */}
        <g>
          <rect x="650" y="155" width="150" height="100" rx="12" fill="rgba(217,119,6,0.07)" stroke="#D97706" strokeWidth="1.5"/>
          <text x="725" y="182" textAnchor="middle" style={{ fontFamily:"monospace", fontSize:10, fill:"#D97706", fontWeight:700, letterSpacing:"0.1em" }}>MEMORY</text>
          <text x="725" y="200" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:12, fontWeight:600, fill:T1 }}>128K limit</text>
          ...
          <text x="725" y="248" textAnchor="middle" style={{ fontFamily:"monospace", fontSize:10, fill:"#D97706" }}>↳ prevents crash</text>
        </g>
      </svg>
    ...
    <div style={{ background:"#fff", border:`1px solid rgba(29,78,216,0.14)`, borderRadius:18, padding:"28px 24px", boxShadow:"0 4px 20px rgba(29,78,216,0.06)", margin:"24px 0" }}>
      <svg viewBox="0 0 820 240" style={{ width:"100%", height:"auto", display:"block" }} xmlns="http://www.w3.org/2000/svg">
        ...
        <g>
          ...
          <text x="85" y="94" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:13, fontWeight:600, fill:T1 }}>Skill / Prompt</text>
        ...
        {/* SKIP branch (down) */}
        <path d="M270 145 L270 180" stroke="#DC2626" strokeWidth="1.5" fill="none" markerEnd="url(#t-arrow-red)" strokeDasharray="5 4">
          <animate attributeName="stroke-dashoffset" values="0;-16" dur="1.2s" repeatCount="indefinite" begin="0.5s"/>
        </path>
        <rect x="195" y="182" width="150" height="28" rx="8" fill="rgba(220,38,38,0.08)" stroke="#DC2626" strokeWidth="1"/>
        <text x="270" y="200" textAnchor="middle" style={{ fontFamily:"monospace", fontSize:11, fill:"#DC2626", fontWeight:600 }}>SKIP — not worth it</text>
        ...
        <g>
          ...
          <text x="718" y="98" textAnchor="middle" style={{ fontFamily:"monospace", fontSize:11, fill:"#DC2626", fontWeight:600 }}>BEFORE: 1,240 tok</text>
          <text x="718" y="115" textAnchor="middle" style={{ fontFamily:"monospace", fontSize:11, fill:GR, fontWeight:600 }}>AFTER:  390 tok</text>
          <text x="718" y="132" textAnchor="middle" style={{ fontFamily:"'Sora',system-ui", fontSize:12, fontWeight:700, fill:P }}>68.5% saved ↓</text>
        </g>
      </svg>
    </div>
  );
          ...
          <main className="aisk-main" style={{ gridColumn:2, marginLeft:280, paddingBottom:120 }}>
            ...
            <section id="hero" ref={el => { sectionRefs.current.hero = el; }} style={{ padding:"52px 0 40px", borderBottom:`1px solid rgba(29,78,216,0.1)` }}>
              <div style={{ maxWidth:820, margin:"0 auto", padding:"0 56px" }}>
                ...
                <h1 style={{ fontFamily:"'Sora',system-ui,sans-serif", fontSize:"clamp(52px,7vw,100px)", fontWeight:800, lineHeight:0.97, letterSpacing:"-0.04em", color:T1, marginBottom:24 }}>
                  AI Agent<br/>
            ...
            <section id="optimizer" ref={el => { sectionRefs.current.optimizer = el; }} style={{ padding:"52px 0", borderBottom:`1px solid rgba(29,78,216,0.08)`, scrollMarginTop:80, background:"rgba(248,247,255,0.5)" }}>
              <div style={{ maxWidth:820, margin:"0 auto", padding:"0 56px" }}>
                ...
                <div ref={registerReveal} className="aisk-reveal d2" style={{ background:"#fff", border:`1px solid rgba(29,78,216,0.12)`, borderRadius:14, padding:"4px 20px 4px", boxShadow:"0 2px 12px rgba(29,78,216,0.05)" }}>
                  ...
                  ].map((c,i) => <Cap key={i} n={i+1} text={c} color="#D97706" />)}
                </div>
              ...
              <div style={{ maxWidth:820, margin:"0 auto", padding:"0 56px" }}>
                ...
                <div ref={registerReveal} className="aisk-reveal d1" style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(170px,1fr))", gap:12, marginTop:16 }}>
                  {[
                    ...
                    { name:"Framer Motion",   cat:"UI",         color:"#D97706" },
                    { name:"Prompt Caching",  cat:"Efficiency", color:"#D97706" },
